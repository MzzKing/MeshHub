  ...
  <el-container>
    ...
    <el-row class="modelList">
      <el-col :span="24">
        ...
        <el-row class="oneModel" v-for="item in modelInfo.records" :key="item.id" @click.native="toModelShow(item.id)">
          <el-col :span="5">
          ...
          <el-col :span="3">
            ...
            <el-col :span="11" id="deleteBtn" @click.stop.prevent.native="deleteModel(item.id)">删除</el-col>
          </el-col>
...
export default {
  ...
  created() {
    axios.get("api/models/"+this.userId+"/"+this.pagination.currentPage+"/"+this.pagination.pageSize).then((res)=>{
